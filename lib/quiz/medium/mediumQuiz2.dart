...
class mediumQuiz2 extends StatefulWidget {
  @override
  State<mediumQuiz2> createState() => _mediumQuiz2();
}

class _mediumQuiz2 extends State<mediumQuiz2> {
  @override
                            ...
                            children: <Widget>[
                              ...
                              Container( //문제
                                ...
                                child: ListView(
                                  children: <Widget>[
                                    Center(
                                      child: Text('Q. 조선 군이 물리쳤다고 기록에 전해지는 왜군의 배 개수는?',
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: TextButton(
                                              ...
                                              child: const Text('1. 33척', style: TextStyle(fontSize: 14.0,color: Colors.black),
                                              )
                                          ),
                                        ),
                                        SizedBox(width: 10),
                                        Container(
                                          ...
                                          child: TextButton(
                                              ...
                                              child: const Text('2. 133척', style: TextStyle(fontSize: 14.0,color: Colors.black),
                                              )
                                          ),
                                        ),
                                        SizedBox(width: 10),
                                        Container(
                                          ...
                                          child: TextButton(
                                              ...
                                              child: const Text('3. 100척', style: TextStyle(fontSize: 14.0,color: Colors.black),
                                              )
                                          ),
                                        ),
                                        SizedBox(width: 10),
                                        Container(
                                          ...
                                          child: TextButton(
                                              ...
                                              child: const Text('4. 103척', style: TextStyle(fontSize: 14.0,color: Colors.black),
                                              )
                                          ),
                                        ),
                                        SizedBox(width: 10),
                                        Container(
                                          ...
                                          child: TextButton(
                                              ...
                                              child: const Text('5. 123척', style: TextStyle(fontSize: 14.0,color: Colors.black),
                                              )
                                          ),
                                        ),
                                      ],
