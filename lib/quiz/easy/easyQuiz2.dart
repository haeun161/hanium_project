...
import 'package:history_gamification/quiz/easy/easyQuiz3.dart';
import 'package:history_gamification/quiz/timer.dart';
import 'package:history_gamification/quizPage.dart';

class easyQuiz2 extends StatefulWidget {
  @override
  State<easyQuiz2> createState() => _easyQuiz2();
}

class _easyQuiz2 extends State<easyQuiz2> {
  @override
                        ...
                        Row(
                            children: <Widget>[
                              ...
                              Container( //문제
                                ...
                                child: ListView(
                                  children: <Widget>[
                                    Text('Q. 명량해전이 벌어진 장소는? (힌트: 좁고 물살이 빠른 곳)',
